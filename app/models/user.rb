...
class User < ApplicationRecord
  ...
  has_many(:received_follow_requests, class_name: "FollowRequest", foreign_key: "recipiend_id", primary_key: "id")
  ...
  has_many(:accepted_sent_follow_requests, scope: follow_accepted, class_name: "FollowRequest", foreign_key: "sender_id", primary_key: "id")
  ...
  has_many(:accepted_received_follow_requests, scope: follow_accepted, class_name: "FollowRequest", foreign_key: "recipiend_id", primary_key: "id")
  ...
  has_many(:commented_photos, scope: follow_accepted through: :accepted_received_follow_requests, source: :photo)
